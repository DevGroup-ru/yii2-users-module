...
use DevGroup\Users\widgets\SocialNetworksWidget;

$loginChildView = UsersModule::module()->authorizationScenario()->loginFormPartialView();
?>
...
<?php if (UsersModule::module()->enableSocialNetworks === true) : ?>
